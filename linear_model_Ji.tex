...
<<<<<<< HEAD
The naive apprach to use low precision samples $\hat{\a}_t := Q(\a_t)$ is 
=======
...
>>>>>>> 53ed983bc6f25525cd7066584eeb6ee23e197e6f
\[
...
\end{lemma}
It suggests that minimizing $\mathcal{TV}(\a_t)$ is key for reducing variance. 
