...
framework towards answering these questions and
present both positive and negative results
we got with this framework. As shown in 
Figure~\ref{fig:highlight}, (a) for linear
models, with rigorous theoretical guarantee, 
...
We consider the convergence properties of the algorithm when a lossy compression scheme is applied to the data (samples), 
