...
The promise is simple and compelling: by reducing precision, we reduce computation\footnote{or inference}, communication, and power costs by an order of magnitude, which can lead to an order-of-magnitude  end-to-end speedup. 
